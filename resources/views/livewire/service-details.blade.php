            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="{{route('home.view')}}" wire:navigate>Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="{{route('services.view')}}" wire:navigate>Services</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="service-details.html">Web Design</a>
                        </li>
                    </ul>
                </div>
            </div>
